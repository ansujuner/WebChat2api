export const IpcChannels = {
  ...
  ACCOUNTS_LIVENESS_START: 'accounts:livenessStart',
  ACCOUNTS_LIVENESS_GET: 'accounts:livenessGet',
  ACCOUNTS_LIVENESS_CANCEL: 'accounts:livenessCancel',
  ACCOUNTS_LIVENESS_CHANGED: 'accounts:livenessChanged',
  ...
  APP_GET_RUNTIME_INFO: 'app:getRuntimeInfo',
  ...
  TOOL_CALLING_GET_STATUS: 'toolCalling:getStatus',
  TOOL_CALLING_RUN_SMOKE: 'toolCalling:runSmoke',
