...
export const deepseekConfig: BuiltinProviderConfig = {
  ...
  enabled: true,
  description: 'DeepSeek V4: Flash (Fast), Pro (Expert), and Flash Vision Exp (Vision)',
  // Exact official IDs; thinking/search options are not separate models.
  supportedModels: ['deepseek-v4-flash', 'deepseek-v4-pro', 'deepseek-v4-flash-vision-exp'],
  modelMappings: {
