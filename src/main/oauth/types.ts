...
export interface ManualTokenConfig {
  providerType: ProviderType
  tokenType: TokenType
  /** Canonical persisted field; distinct from the credential's token/cookie format. */
...
export const MANUAL_TOKEN_CONFIGS: Record<ProviderType, ManualTokenConfig[]> = {
  arena: [],
  // MiMo needs all three cookie values together; none is an alternative login token.
  mimo: [
    {
      providerType: 'mimo', tokenType: 'cookie', credentialKey: 'service_token',
      label: 'Service Token', placeholder: 'Enter serviceToken from Cookie',
      description: 'Use the serviceToken cookie together with userId and xiaomichatbot_ph from the same MiMo Studio account.',
      helpUrl: 'https://aistudio.xiaomimimo.com',
    },
    {
      providerType: 'mimo', tokenType: 'cookie', credentialKey: 'user_id',
      label: 'User ID', placeholder: 'Enter userId from Cookie',
      description: 'Use the userId cookie from the same account as serviceToken and xiaomichatbot_ph.',
      helpUrl: 'https://aistudio.xiaomimimo.com',
    },
    {
      providerType: 'mimo', tokenType: 'cookie', credentialKey: 'ph_token',
      label: 'PH Token', placeholder: 'Enter xiaomichatbot_ph from Cookie',
      description: 'Use the xiaomichatbot_ph cookie together with serviceToken and userId.',
      helpUrl: 'https://aistudio.xiaomimimo.com',
    },
  ],
  zai: [
    {
      providerType: 'zai', tokenType: 'jwt', credentialKey: 'token',
      label: 'Access Token (JWT)', placeholder: 'Enter the Z.ai web account JWT token',
      description: 'Use the signed-in chat.z.ai account token, not a Z.ai API platform key or a guest token.',
