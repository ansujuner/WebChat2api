...
export type ProviderVendor = 'deepseek' | 'glm' | 'kimi' | 'mimo' | 'minimax' | 'qwen' | 'qwen-ai' | 'zai' | 'perplexity' | 'arena' | 'custom'
...
export interface ContextManagementConfig {
  enabled: boolean
  strategies: {
    slidingWindow: { enabled: boolean; maxMessages: number }
    tokenLimit: { enabled: boolean; maxTokens: number }
    summary: { enabled: boolean; keepRecentMessages: number; summaryPrompt?: string }
  }
